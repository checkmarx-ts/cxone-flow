...
class PRQueueConstants:
    ...
    EXCHANGE_SCAN_INPUT_LEGACY = (
        f"{CxOneFlowAbstractWorkflowService.ELEMENT_PREFIX}{PR_ELEMENT_PREFIX}Scan In"
    )
    ...
    EXCHANGE_PRESCAN_ANNOTATE = f"{CxOneFlowAbstractWorkflowService.ELEMENT_PREFIX}{PR_ELEMENT_PREFIX}Prescan Annotate"
    ...
    QUEUE_PRESCAN_ANNOTATE_PR = f"{CxOneFlowAbstractWorkflowService.ELEMENT_PREFIX}{PR_ELEMENT_PREFIX}Prescan PR Annotating"
    ...
    ROUTEKEY_PRESCAN_ANNOTATE_PR = f"{CxOneFlowAbstractWorkflowService.TOPIC_PREFIX}{PR_TOPIC_PREFIX}{ScanStates.PRESCAN}.{FeedbackWorkflow.PR}.*"
