...
\begin{itemize}
    \item Now using the cxone-async-api (https://github.com/checkmarx-ts/cxone-async-api) rather than a copy embedded in the repository.
    ...
    \item The \texttt{cxoneflow-resolver-agent} supports SCA Resolver execution via containers using the \texttt{cx-supply-chain-toolkit} (https://github.com/checkmarx-ts/cx-supply-chain-toolkit).
