...
\begin{itemize}
    ...
    \item The \texttt{cxoneflow-resolver-agent} supports SCA Resolver execution via containers using the \href{https://github.com/checkmarx-ts/cx-supply-chain-toolkit}{\textbf{cx-supply-chain-toolkit}}.
