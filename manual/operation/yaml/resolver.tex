...
The number of times a request for a resolver scan will be retried after the initial request if no Scan Agent handles the scan.
Any scan request not handled by a Scan Agent before the \intlink{sec:resolver-scan-timeout-seconds}{scan-timeout-seconds} setting 
