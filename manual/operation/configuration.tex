...
\dirtree{%
    ...
    .5 \hyperref[sec:yaml-generic-amqp-amqp-user]{amqp-user} \DTcomment{[Optional]}.
    .5 \hyperref[sec:yaml-generic-ssl-verify]{ssl-verify} \DTcomment{[Optional] Default: True}.
    .3 \hyperref[sec:yaml-resolver-allowed-agent-tags]{allowed-agent-tags} \DTcomment{[Required]}.
    .3 \hyperref[sec:yaml-resolver-capture-resolver-logs]{capture-resolver-logs} \DTcomment{[Optional] Default: False}.
    .3 \hyperref[sec:yaml-resolver-default-agent-tag]{default-agent-tag} \DTcomment{[Optional]}.
    .3 \hyperref[sec:yaml-resolver-private-key]{private-key} \DTcomment{[Required]}.
    .3 \hyperref[sec:yaml-resolver-resolver-tag-key]{resolver-tag-key} \DTcomment{[Optional] Default: resolver}.
}
