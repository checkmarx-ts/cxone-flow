...
\dirtree{%
    ...
    .2 \intlink{sec:yaml-scm-monikers}{<scm moniker>} \DTcomment{[At least 1 required: \textbf{bbc}, \textbf{bbdc}, \textbf{adoe}, \textbf{gh}, \textbf{gl}]}.
...
\dirtree{%
    .1 <root>.
    .2 \intlink{sec:yaml-scm-monikers}{<scm moniker>} \DTcomment{[Limited to: \textbf{bbc}, \textbf{bbdc}, \textbf{adoe}, \textbf{gh}, \textbf{gl}]}.
...
\dirtree{%
    .1 <root>.
    .2 \intlink{sec:yaml-scm-monikers}{<scm moniker>} \DTcomment{[Required: \textbf{bbc}, \textbf{bbdc}, \textbf{bbdc}, \textbf{adoe}, \textbf{gh}, \textbf{gl}]}.
    .3 \intlink{sec:yaml-moniker-connection}{connection} \DTcomment{[Required]}.
    ...
    .5 \intlink{sec:yaml-api-auth-sp-client-id}{sp-client-id} \DTcomment{[See element documentation]}.
    .5 \intlink{sec:yaml-api-auth-sp-client-secret}{sp-client-secret} \DTcomment{[See element documentation]}.
    .5 \intlink{sec:yaml-api-auth-sp-tenant-id}{sp-tenant-id} \DTcomment{[See element documentation]}.
...
\dirtree{%
    .1 <root>.
    .2 \intlink{sec:yaml-scm-monikers}{<scm moniker>} \DTcomment{[Required: \textbf{bbc}, \textbf{bbdc}, \textbf{bbdc}, \textbf{bbdc}, \textbf{adoe}, \textbf{gh}, \textbf{gl}]}.
    .3 \intlink{sec:yaml-moniker-cxone}{cxone} \DTcomment{[Required]}.
...
\dirtree{%
    .1 <root>.
    .2 \intlink{sec:yaml-scm-monikers}{<scm moniker>} \DTcomment{[Required: \textbf{bbc}, \textbf{bbdc}, \textbf{adoe}, \textbf{gh}, \textbf{gl}]}.
    .3 \intlink{sec:yaml-moniker-feedback}{feedback} \DTcomment{[Optional]}.
    ...
    .5 \intlink{sec:pull-request-elements}{...see "YAML \texttt{pull-request} Elements"}.
...
\pagebreak
\paragraph{YAML \texttt{pull-request} Elements}\label{sec:pull-request-elements}
\noindent\\
...
\dirtree{%
    ...
    .5 \intlink{sec:yaml-pull-request-use-policies}{use-policies} \DTcomment{[Optional] Default: False}.
    .5 \intlink{sec:yaml-pull-request-gh-pr-opts}{gh-pr-opts} \DTcomment{[Optional]}.
    .6 \intlink{sec:yaml-pull-request-gh-pr-opts-check-name}{check-name} \DTcomment{[Optional] Default: CheckmarxOne Scan}.
    .5 \intlink{sec:yaml-pull-request-bb-pr-opts}{bb-pr-opts} \DTcomment{[Optional]}.
    .6 \intlink{sec:yaml-pull-request-bb-pr-opts-check-name}{check-name} \DTcomment{[Optional] Default: CheckmarxOne Scan}.
    .5 \intlink{sec:yaml-pull-request-adoe-pr-opts}{adoe-pr-opts} \DTcomment{[Required for ADOE if \texttt{use-policies} is \textbf{true}.]}.
    .6 \intlink{sec:yaml-pull-request-adoe-pr-opts-check-name}{check-name} \DTcomment{[Required]}.
    .6 \intlink{sec:yaml-pull-request-adoe-pr-opts-check-genre}{check-genre} \DTcomment{[Optional]}.
}
