...
of \texttt{BitbucketKickoffMsg} is sent to the \texttt{/bbdc/kickoff} or \texttt{/bbc/kickoff} endpoints
to start a scan for the repository described by the message.
