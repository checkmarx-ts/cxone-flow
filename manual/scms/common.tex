...
not strictly required to assign policies to \cxone projects; scan status for projects without assigned policies
...
the scan status for the SCM to use to ensure a successful scan is completed. 
