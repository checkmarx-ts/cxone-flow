\chapter{BitBucket Data Center}\label{sec:bbdc}

\section{About BitBucket Data Center}

BitBucket Data Center is an on-premise, self-hosted SCM that is often confused with \intlink{sec:bbc}{BitBucket Cloud};
...
for use with BitBucket Data Center.
