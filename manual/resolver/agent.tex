...
The intention of this feature is to allow a small amount of prepration of the code
...
\begin{enumerate}
  ...
  \item Add the single line:\\"\texttt{resolver ALL=(cx-sca-agent-rt) NOPASSWD: SETENV: /path/to/ScaResolver}"
...
\dirtree{%
    ...
    .4 \intlink{sec:scan-agent-work-path}{scan-agent-work-path}\DTcomment{[Optional] Default: /tmp/scan-agent}.
